...
const getNames = (arr) => {
  ...
  let newArr = arr.map(ele => (ele.name.split("")).reverse().join(""))
...
Write a function that appends ' The end.' to a string,
 and returns the modified string. The original source string should not be modified.
