...
const maxInArray = (arr) => {
  // Solution code here...
  let max = arr.reduce((pre , cur) => pre < cur ? cur : pre)
  return max
};
...
const checkValues = (obj, value) => {
  // Solution code here...
  console.log(Object.values(obj)[0] === value);
  if(Object.values(obj)[0] === value) return true
  return false
...
const getHouses = (arr) => {
  let houses = arr.map(ele => ele.house)
  // Solution code here...
  return houses;
};
...
const hasChildrenValues = (arr, character) => {
  // Solution code here...
  let check = arr.filter(ele => ele.name === character )
  if(check[0].children) {return true}
