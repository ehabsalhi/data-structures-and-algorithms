...
const sortByChildren = (charArray) => {
  // Solution code here...
  characters.sort((a,b) => a.house.localeCompare(b.house))
  characters.sort((a,b) => a.children.length - b.children.length )
    return charArray
};
...
Write a function named containsW that takes in a string.
 This function should use a regular expression pattern to return true if the string contains the letter 'w' in lower case or false if it does not. 
...
and uses a regular expression pattern to return a new array containing any cities that begin with the letters A through J, inclusive.
------------------------------------------------------------------------------------------------ */
