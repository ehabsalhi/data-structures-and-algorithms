...
const toLastNames = arr => {
  // Solution code here...
  let map = arr.map(ele => `${ele.firstName} ${ele.lastName}`)
  return map
};
...
const addValues = (arr) => {
  // Solution code here...
  let val = arr.reduce(((pre,curr) => pre + curr) ,0)
  return val
};
...
const addPurchases = (arr) => {
  ...
  let val = arr.reduce(((pre,curr) => ( pre.purchasePrice + curr.purchasePrice) ))
  return val
};
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let i = 0
  arr.reduce((pre,curr,index) => i = index )
  return i + 1
};
...
const reversedString = (str) => {
  // Solution code here...
  let newArr = []
  str.split("").reduce(((pre , cur) => newArr.unshift(cur)),0)
  return newArr.join("")
};
