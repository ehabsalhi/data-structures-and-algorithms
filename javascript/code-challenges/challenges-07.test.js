...
Your function should use slice within a loop and return an array of each successive string result from losing letters to the sharpener,
...
const listFoods = (recipe) => {
  let result = [];
  // Solution code here...
  let arr = recipe.ingredients.map(ele => ele.slice(ele.indexOf(" ") + 1))
  let newArr = arr.map(ele => ele.slice(ele.indexOf(" ") + 1))
